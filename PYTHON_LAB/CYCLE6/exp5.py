'''Create a class Time with private attributes hour, minute and second. Overload ‘+’ operator
...
class Time:
    ...
    def __add__(self, other):
        total_seconds1 = (self.__hour * 3600 + self.__minute * 60 + self.__second)
        total_seconds2 = (other.__hour * 3600 + other.__minute * 60 + other.__second)
